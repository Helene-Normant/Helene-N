              ...
              <article>
                    <div className='cards-content-container'>
                             <div className='cards-img-container'>
                              ...
                              <div className='cards-title-container flex flex-col p-4 xxs:w-[20.5em] xxs:h-[11.663] xs:w-[23.375em] xs:h-[13.294em] sm:w-[33.375em] sm:h-[18.938em] md:w-[33.375em] md:h-[18.938em] lg:w-[25.375em] lg:h-[14.438em] xl:w-[30.375em] xl:h-[17.25em] 2xl:w-[34em] 2xl:h-[19.375em] 3xl:w-[45.375em] 3xl:h-[25.813em]'>
