         ...
         <div className="header-line mt-3 border-[0.044em] border-solid border-dark"><hr /></div>
            <div className='header-buttons-container flex justify-between' >
                <div className='link-header-container flex items-center'>
                    <h1 className='download-arrow-header ml-[4.563rem] text-3xl text-dark'> <BsArrowRight/> </h1>
                    <h1>
                     <a href={CV} download className='download-link-header header-hover-download text-3xl cursor-pointer'>DOWNLOAD CV </a>
                    </h1>
                     <h1 className='contact-arrow-header ml-[12.5rem] text-center text-3xl text-dark'> <BsArrowDown /> </h1>
                 <div>
             ...
             <div className='flex header-title-container'>  
                <div className='header-denomination-container bg-medium w-[12.5em] text-center'>
                ...
                <div className='header-full-name-container'>
                     <h1 className='name-title-header w-[8.125rem] text-center text-3xl text-dark border-[0.031em] border-b border-r border-solid border-dark'>HELENE</h1>
                     <h1 className='surname-title-header w-[10rem] ml-[8.063rem] text-center text-3xl text-dark border-[0.031em] border-t border-l border-solid border-dark'>NORMANT</h1>
                    </div>
              </div>  
            </div>
